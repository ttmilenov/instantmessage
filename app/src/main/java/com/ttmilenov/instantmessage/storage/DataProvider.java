...
public class DataProvider extends ContentProvider{
    ...
    static {
        ...
        uriMatcher.addURI("com.ttmilenov.instantmessage.provider", "messages", MESSAGES_ALLROWS);
        uriMatcher.addURI("com.ttmilenov.instantmessage.provider", "messages/#", MESSAGES_SINGLE_ROW);
        uriMatcher.addURI("com.ttmilenov.instantmessage.provider", "profile", PROFILE_ALLROWS);
        uriMatcher.addURI("com.ttmilenov.instantmessage.provider", "profile/#", PROFILE_SINGLE_ROW);
    }
